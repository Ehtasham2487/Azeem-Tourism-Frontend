...
const steps = ["Tours Details", "Review Your Package"];
...
export default function Checkout() {
  ...
  const updateMyPackage = () => {
    ...
    const URL = `https://smart-travel-b06756646a16.herokuapp.com/api/tours/update/${packageData._id}`;
    axios
      .post(URL, data)
      .then((response) => {
        ...
        >
          ...
          {activeStep === steps.length ? (
            <React.Fragment>
              ...
              <Button
                variant="contained"
                onClick={() => navigate("/admin/managetours")}
                sx={{ mt: 3, ml: 1 }}
              >
                GoTo Manage Tours
              </Button>
