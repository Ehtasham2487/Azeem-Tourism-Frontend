import{r as o,w,q as p,j as e,L as C,t as f,T as x,I as m,x as D,v as b,C as N,y as S,s as y,A as T}from"./index-Qm37-hOS.js";import{d as I,a as $,D as j,M as A,A as R,b as L}from"./ExitToApp-lAv1ZvSx.js";import{s as P}from"./styled-components.browser.esm-27Qsjwnj.js";import"./Tooltip-RdJNKoi-.js";import{C as z}from"./Card-rp43y1kq.js";import{I as g,R as F,d as _}from"./DeleteForever-IBOv72uH.js";import{d as B,T as E,L as M}from"./VisibilityOff-HjpOYbqA.js";import{T as h}from"./Tooltip-kFKRgWfz.js";import{C as W}from"./CssBaseline-bzgSFrbW.js";import"./ListItemText-7Ghp6EMP.js";import"./capitalize-5rU_-DoW.js";function H(){const[t,r]=o.useState([]);o.useState(!0);const[s,d]=o.useState(!1),c=w();o.useEffect(()=>{const a="http://localhost:8080/api/packages/get";p.get(a).then(i=>{const l=i.data.filter(k=>k.active===!0);r(l)}).catch(i=>{})},[s]);const n=async a=>{const i=`http://localhost:8080/api/packages/update/${a}`;await p.post(i,{active:!1}).then(l=>{d(!s)}).catch(l=>{})},v=async a=>{const i=`http://localhost:8080/api/packages/delete/${a}`;await p.delete(i).then(l=>{d(!s)}).catch(l=>{})};return o.useState(1),e.jsx(O,{id:"AdminPackagesCard",children:e.jsx("div",{className:"grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 mx-5 p-3 bg-white rounded-lg shadow-lg border-2",children:t.map(a=>e.jsx(e.Fragment,{children:e.jsxs(z,{className:"shadow-lg rounded-lg lg:w-90 border-2 h-auto w-auto relative",children:[e.jsxs("div",{className:"icon flex justify-center",children:[e.jsx("img",{src:a.images[0].image,alt:"",style:{width:"100%",borderRadius:"10px",height:"100%"}}),(a==null?void 0:a.isDiscounted)&&e.jsxs("div",{className:"absolute top-0 right-0 bg-red-500 text-white py-1 px-3 rounded-tl-lg",children:[a.Discount,"% OFF"]})]}),e.jsx("p",{className:"text-center text-md font-semibold mb-0",children:a.title}),e.jsx("p",{className:"text-justify w-full h-24 overflow-auto font-normal text-zinc-700 text-sm mt-0",children:a.description}),e.jsx("div",{className:" flex justify-between flex-row",children:e.jsxs("div",{children:[e.jsxs("span",{className:"font-bold text-md",children:["Available Ticket:"," "]}),e.jsx("span",{className:"text-md",children:a.totalCount})]})}),e.jsxs("div",{className:"flex items-center",children:[a.isDiscounted&&e.jsx("p",{className:"text-gray-500 line-through mr-2",children:"$"+a.price}),e.jsx("p",{className:"font-bold text-lg mt-1 mr-auto",children:"$"+(a.isDiscounted?a.price-a.price*a.Discount/100:a.price)})]}),e.jsx("div",{children:e.jsxs("p",{className:"text-justify w-full h-24 overflow-auto font-normal text-zinc-700 text-sm mt-0",children:["For Region: ","",a.region?a.region:null]})}),e.jsxs("div",{className:"flex justify-around bg-white text-zinc-800 hover:text-white transition-colors duration-100 text-md font-medium text-center rounded-lg bg-primary-700 w-full",children:[e.jsx(h,{title:"Edit",children:e.jsx(g,{onClick:()=>c("/admin/editPackageDetails",{state:a}),"aria-label":"Edit",className:"h-5 w-5",children:e.jsx(C,{to:{pathname:"/admin/editPackageDetails",state:"destination"},style:{textDecoration:"none",color:"grey"},children:e.jsx(F,{style:{color:"black"}})})})}),e.jsx(h,{title:"Hide",children:e.jsx(g,{onClick:()=>{n(a._id)},"aria-label":"Hide",className:"h-5 w-5",children:e.jsx(B,{style:{color:"black"}})})}),e.jsx(h,{title:"Delete",children:e.jsx(g,{onClick:()=>{v(a._id)},"aria-label":"Delete",className:"h-5 w-5",children:e.jsx(_,{style:{color:"red"}})})})]})]})}))})})}const O=P.section`
  padding: 2rem 0;
  .title {
    text-align: center;
  }
