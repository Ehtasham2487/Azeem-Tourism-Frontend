...
export default function AdminPackagesCard() {
  ...
  const updateVisibility = async (id) => {
    const URL = `https://smart-travel-b06756646a16.herokuapp.com/api/tours/update/${id}`;
    await axios
      .post(URL, {
        active: true,
      })
  ...
  const removeTour = async (id) => {
    const URL = `https://smart-travel-b06756646a16.herokuapp.com/api/tours/delete/${id}`;
    await axios
      .delete(URL)
      .then((response) => {
        setReload(!reload);
          ...
          return (
            <Card className="shadow-lg rounded-lg lg:w-90 border-2 h-auto w-auto">
              ...
              <div className=" flex justify-between flex-row">
                <div>
                  <span className="font-bold text-md">Available Ticket: </span>
